...
> Данный метод принимает id или серийный номер. По id можно получить устройства, которыми владеет текущий аккаунт, а также устройства к которым предоставлен доступ. По серийному номеру можно получить только устройства, владельцем которых является текущий аккаунт
