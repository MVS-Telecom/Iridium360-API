...
> *По умолчанию можно указать только email аккаунта или верифицированный мобильный номер аккаунта, которому принадлежит API токен. Для отправки сообщений используя чужой номер или email обратитесь в поддержку support@iridium360.ru
