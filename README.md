...
> Передав только параметр `startId` будут выданы сообщения "вверх" по хронологии начиная с указанного. 
> Передав только параметр `endId` будут выданы сообщения "вниз" по хронологии начиная с указанного. 
...
> ***По умолчанию можно указать только email аккаунта или верифицированный мобильный номер аккаунта, которому принадлежит API токен. Для отправки сообщения от имени чужого номера или email обратитесь в поддержку support@iridium360.ru
